...
public class TripEditActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Получаем идентификатор путешествия из Intent
        ...
        tripName.setText(getIntent().getStringExtra("TRIP_NAME"));
        tripStartDate.setText(getIntent().getStringExtra("TRIP_START_DATE"));
        tripEndDate.setText(getIntent().getStringExtra("TRIP_END_DATE"));
        tripType.setText(getIntent().getStringExtra("TRIP_TYPE"));
        ...
        saveButton.setOnClickListener(v -> doUpdateTrip());
    ...
    private void doUpdateTrip() {
        ...
        tripViewModel.updateTrip(tripId, request).observe(this, resource -> {
            ...
            switch (resource.status) {
                ...
                case SUCCESS:
                    ...
                    Toast.makeText(TripEditActivity.this, "Путешествие обновлено", Toast.LENGTH_SHORT).show();
                    Intent intent = new Intent(TripEditActivity.this, TripsActivity.class);
                    startActivity(intent);
                    break;
                case ERROR:
                    progressBar.setVisibility(android.view.View.GONE);
                    Toast.makeText(TripEditActivity.this, "Ошибка: " + resource.message, Toast.LENGTH_LONG).show();
                    break;
            }
        });
    }
